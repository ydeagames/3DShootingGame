...
void PhysXRenderer::RenderGeometry(GameContext& context, const PxGeometry& geom, const PxMat44& pxworld, const PxVec3& pxcolor, bool wireframe)
{
	...
	static auto sphere = CreateCircleSphere(context.GetDR().GetD3DDeviceContext());
	static auto spherehalf = CreateCircleSphere(context.GetDR().GetD3DDeviceContext(), true);
